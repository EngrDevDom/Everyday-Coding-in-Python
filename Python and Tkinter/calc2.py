...
class SLabel(Frame):
    ...
    def __init__(self, master, left1, right1):
        ...
        Label(self, text=right1, fg='white', font=("arial", 6, "bold"), width=1, bg='gray40').pack(side=LEFT, expand=YES, fill=BOTH)
...
class Calculator(Frame):
    def __init__(self, parent=None):
        ...
        self.actionDict = {'second':    self.doThis, 'mode':    self.doThis,
                           ...
                           'vars':      self.doThis, 'clear':   self.doThis,
    ...
    self.display = Pmw.ScrolledText(self, hscrollmode='dynamic', vscrollmode='dynamic',
                                    hull_relief='sunken', hull_background='gray40',
                                    hull_borderwidth=10, text_background='honeydew4',
                                    text_width=16, text_foreground='black',
                                    text_height=6, text_padx=10, text_pady=10, text_relief='groove',
