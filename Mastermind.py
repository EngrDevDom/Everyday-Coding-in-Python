...
def try_it(c1,c2,c3,c4):
    print("The columns are: (r)ed, (b)lue, (o)range, (y)ellow, (p)ink, (g)reen and (w)hite")
    try_again = True
    ...
    if c2 == u2:
        correct += 1
    elif c2 == u2 or c2 == u3 or c2 == u4:
        wrong_place += 1
    if c3 == u3:
        correct += 1
    elif c3 == u2 or c3 == u3 or c3 == u4:
        wrong_place += 1
    if c4 == u1:
        correct += 1
    elif c4 == u2 or c4 == u3 or c4 == u4:
        wrong_place += 1
...
def main():
    ...
    play = True
    while play == True:
        (correct,wrong_place) = try_it(c1,c2,c3,c4)
        score += 1
        if correct == 4:
            play = False
    print("You win!")
