# File  :   Tweaking_colors.py
# Desc  :   Script for Tweaking Colors
...
def create_scales(height):
    ...
    for x in range(640):
        ...
        pygame.draw.rect(green_scale_surface, red, line_rect)
        pygame.draw.rect(blue_scale_surface, red, line_rect)
